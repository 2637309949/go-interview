(function () {
  ...
  function config (vm) {
    ...
    if (config.loadCatalog === true) {
      config.loadCatalog = '_navbar' + config.ext;
    }
  ...
  function main(config) {
    ...
    var aside1 =
    '<aside class="catalog">' +
      '<div class="catalog-nav"><!--catalog--></div>' +
    '</aside>';
    var aside2 =
      '<aside class="sidebar">' +
  ...
  ********************************************** */
   ...
   * @param {String} text Text content
   * @param {Number} level Type of heading (h<level> tag)
   * @returns {String} Navbar element
   */
  Compiler.prototype.navbar = function navbar () {
    var ref = this.config;
      var logo = ref.logo;
      var name = ref.name;
    var html = (logo ? ("<p><a href=\"#/\" title=\"\"><img src=\"" + logo + "\" data-origin=\"" + logo + "\" alt=\"\"></a></p>") : '') +
    (name ? ("<p>" + name + "</p>") : '');
    return html;
  };
  ...
  function Render(Base) {
    return /*@__PURE__*/(function (Base) {
      ...
      Render.prototype._renderNav = function _renderNav () {
        this._renderTo('nav', this.compiler.navbar());
      };

      Render.prototype._loadCatalog = function _loadCatalog (text) {
        text && this._renderTo('.catalog-nav', this.compiler.compile(text));
        if (this.config.loadCatalog) {
          getAndActive(this.router, '.catalog-nav');
        }
      };
    ...
    return /*@__PURE__*/(function (Base) {
      ...
      Fetch.prototype._fetch = function _fetch (cb) {
        ...
        if (isExternal(path)) {
          ...
          var loadCatalog = ref$2.loadCatalog;
          ...
          loadCatalog &&
            loadNested(
              ...
              qs,
              loadCatalog,
              function (text) { return this$1._loadCatalog(text); },
              this,
              true
            );
        }
